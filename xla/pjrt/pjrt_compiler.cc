...
void PjRtCompilerRegistry::RegisterFactory(absl::string_view platform_name,
  ...
  CHECK(!factories_.contains(key)) << "Factory already registered";
  factories_[key] = std::move(factory);
}

void PjRtCompilerRegistry::RegisterCompiler(
  ...
  CHECK(!compilers_.contains(key)) << "Compiler already registered";
...
void PjRtRegisterCompilerFactory(absl::string_view platform_name,
                                 absl::string_view variant_name,
                                 PjRtCompilerFactory factory) {
  PjRtCompilerRegistry::Global().RegisterFactory(platform_name, variant_name,
                                                 std::move(factory));
}
...
void PjRtRegisterDefaultCompiler(absl::string_view platform_name,
                                 std::unique_ptr<PjRtCompiler> compiler) {
  PjRtCompilerRegistry::Global().RegisterCompiler(platform_name,
                                                  /*variant_name=*/"",
                                                  std::move(compiler));
}
...
void PjRtRegisterCompiler(absl::string_view platform_name,
                          ...
                          std::unique_ptr<PjRtCompiler> compiler) {
  PjRtCompilerRegistry::Global().RegisterCompiler(
